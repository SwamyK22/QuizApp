...
function Header() {
  const { page, setValidateAns, setPage } = useContext(QuizContext);
  const nav = useNavigate();
  return (
      <div className="flex flex-col items-center">
        <div className="flex items-center w-full lg:px-6 p-2">
          {page <= 5 && (
            <div className="lg:text-2xl md:text-xl bg-white px-2 rounded-md text-indigo-900 font-bold flex items-center">
              <svg
          ...
          {page <= 5 && (
            <p className="flex-1 text-center font-bold lg:text-2xl md:text-2xl">
              Fantasy Quiz #156
            </p>
          )}
          <button
        ...
        {page <= 5 && (
          <div className="flex items-center w-[90%] md:hidden sm:flex">
